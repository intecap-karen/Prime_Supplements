            ...
            <div class="container mt-5">
                <div class="row justify-content-center">
                    <div class="col-md-4 text-center">
                        ...
                        <img src="<?= base_url('images/logologin.jpeg') ?>" alt="Logo Cliente" class="img-fluid mb-3"
                        ...
                        <form method="post" action="login_cliente">
                            ...
                            <!--funcion en el controlador que dectectara si los datos no son correctos-->
                            <!--Si la funcion de session obtiene error-->
                        ...
                        <div class="mt-3">
                            <a href="<?=base_url('registrar_cliente')?>" class="btn btn-outline-secondary w-100">¿No
                                tienes cuenta?
                                Regístrate</a>
                        </div>
                    </div>
