    ...
    <main>
        ...
        <div class="row">
            <div class="col-4 offset-4">
                ...
                <form action="<?=base_url('admin/modificar_producto')?>" method="post">
                    <label for="producto_id" class="form-label">Producto_id</label>
                    <input type="number" name="producto_id" id="producto_id" class="form-control" value="<?=esc($datos['producto_id'])?>" readonly>
                    <label for="nombre" class="form-label">Nombre</label>
                    <input type="text" name="nombre" id="nombre" class="form-control" value="<?=$datos['nombre'];?>">
                    <label for="marca_id" class="form-label">marca_id</label>
                    <input type="number" name="marca_id" id="marca_id" class="form-control" value="<?=$datos['marca_id'];?>">
                    <label for="descripcion" class="form-label">descripcion</label>
                    <input type="text" name="descripcion" id="descripcion" class="form-control" value="<?=$datos['descripcion'];?>">
                    <label for="Precio" class="form-label">Precio</label>
                    <input type="number" name="precio" id="precio" class="form-control" value="<?=$datos['precio'];?>">
                    <label for="categoria_id" class="form-label">categoria_id</label>
                    <input type="number" name="categoria_id" id="categoria_id" class="form-control" value="<?=$datos['categoria_id'];?>">
