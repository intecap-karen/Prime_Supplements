        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-4 offset-4">
                    ...
                    <form action="<?= base_url('admin/modificar_marca') ?>" method="post">
                        <input type="hidden" name="marca_id" value="<?= esc($datos['marca_id']) ?>">
                        <label for="numbre" name="marca_id" class="form-label">Marca</label>

                        <label for="marca_nombre" class="form-label">Nombre</label>
                        <input type="text" name="marca_nombre" id="marca_nombre" class="form-control" value="<?= esc($datos['marca_nombre']) ?>" required>

                        <label for="descripcion" class="form-label">Descripción</label>
                        <input type="text" name="descripcion" id="descripcion" class="form-control" value="<?= esc($datos['descripcion']) ?>" required>
