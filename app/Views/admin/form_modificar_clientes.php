...
<head>
    ...
    <title>Modificar Clientes | Prime Suplements</title>
</head>
        ...
        <div class="row">
            <div class="col-4 offset-4">
                ...
                <form action="<?=base_url('modificar_cliente')?>" method="post">
                    ...
                    <input type="number" name="id_cliente" id="id_cliente" class="form-control" value="<?=$datos['cliente_id'];?>" readonly>
                    ...
                    <input type="password" name="pwd_cliente" id="pwd_cliente" class="form-control" value="<?=$datos['contrasenia'];?>">
                    ...
                    <input type="date" name="dt_nacimiento" id="dt_nacimiento" class="form-control" value="<?=$datos['fecha_nac'];?>">
