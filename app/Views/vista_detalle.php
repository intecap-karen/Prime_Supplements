    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>Q <?= esc(number_format($detalle['precio'], 2)) ?></td>
                <td><?= esc($detalle['cantidad']) ?></td>
                <td>Q <?= esc(number_format($detalle['subtotal'], 2)) ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
        ...
        <tfoot>
            <tr>
                ...
                <td class="bg-danger text-white fw-bold">Q <?= esc(number_format($total, 2)) ?></td>

            </tr>
        </tfoot>
    </table>
    <div class="d-flex justify-content-end mt-3">
        <a href="<?= base_url('pedidos_asignados?dpi_empleado=1002') ?>"
            class="btn btn-outline-light fw-bold px-4 py-2 shadow-sm"
